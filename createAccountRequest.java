...
public class createAccountRequest extends Request {
    ...
    private static final String _class =
            createAccountRequest.class.getSimpleName();

    private String userIdentity;
    private String password;

    // Constructor; throws NullPointerException if name is null.
    public createAccountRequest(String userIdentity, String password) {
        // check for null
    ...
    public static createAccountRequest fromJSON(Object val) {
        try {
            ...
            return new createAccountRequest(userIdentity, password);
